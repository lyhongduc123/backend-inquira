...
class RankingService:
    ...
    def rank_papers(
        ...
        for paper in papers:
            # Convert Paper object to dict for scoring
        ...
        # Attach scores to papers for transparency
        for paper in ranked_papers:
            if hasattr(paper, 'ranking_score'):
                paper.ranking_score = paper_scores.get(paper.id, {})
    ...
    def _paper_to_dict(self, paper: Paper) -> Dict[str, Any]:
        ...
        if hasattr(paper, 'openalex_id') and paper.openalex_id:
            ...
            openalex_data = {
                ...
                'open_access': {
                    'is_oa': getattr(paper, 'is_open_access', False)
                },
                'authorships': getattr(paper, 'authorships', []),
                'topics': getattr(paper, 'topics', []),
                'concepts': getattr(paper, 'concepts', []),
                'primary_location': getattr(paper, 'primary_location', {}),
            }
        ...
        if hasattr(paper, 'semantic_scholar_id') and paper.semantic_scholar_id:
            semantic_data = {
                ...
                'influentialCitationCount': getattr(paper, 'influential_citation_count', 0),
